...
'''
def projekteImport(excelDateiPfad:None|str = None,projektedatei:str ="projekte.json"):
    ...
    while i < len(projekteRoh):
        try: 
            ...
            i += 1
    if os.path.exists(dir_path+"/"+projektedatei):
        ...
        try:
            ...
            f = open(dir_path+"/"+projektedatei, "w")
        ...
        with open(dir_path+"/"+projektedatei,"a+") as f:
